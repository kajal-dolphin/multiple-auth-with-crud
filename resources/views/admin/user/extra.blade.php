    ...
    <div class="container">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item active text-dark">User Profile</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-3">
                        <div class="card card-info card-outline" style="height: 280px;">
                            <div class="card-body box-profile">
                                <div class="text-center">
                                    @foreach($userDetail->images as $key => $img)
                                    @if($loop->first)
                                    <img src="{{ asset('storage/images/' . $img->user_id . '/' . $img->image)}}"
                                        class="img-fluid img-circle border border-2" style="width: 130px; height: 130px;">
                                    @endif
                                    @endforeach
                                </div>
                                <h3 class="profile-username text-center pt-4                                                                                                                                                                               ">{{ $userDetail->name }}</h3>
                            </div>
                        </div>
                            ...
                            <div class="card-header">
                                <h4 class="card-title w-100">
                                    <strong class="d-block w-100" data-toggle="collapse"><i
                                            class="fa fa-home fa-fw"></i> Addresses </strong>
                                </h4>
                            </div>
                            <div id="collapseOne" class="collapse show" data-parent="#accordion">
                                <div class="card-body">
                                    ...
                                    <div class="callout callout-info">
                                        <h5><i class="fa fa-info pe-2"></i> Address {{ ++$key}} :-</h5>
                                        <p class="ps-4">{{ $address->address }}</p>
                                    </div>
                                    @endforeach
                                </div>
                            </div>
